    ...
    <group ref={group} {...props} dispose={null}>
      <group name="Sketchfab_Scene">
        <group name="Sketchfab_model" rotation={[-Math.PI / 2, 0, 0]}>
          <group name="root" position={[2,8,3]}>
            <group name="GLTF_SceneRootNode" rotation={[Math.PI / 2, 0, 0]}>
              <group name="mercury_BezierCircle_4" scale={9.695}>
                <group name="mercury_2" position={[0, 0, 1]} rotation={[1.739, -0.875, 1.237]} scale={0.038}>
                  <mesh name="Object_5" geometry={nodes.Object_5.geometry} material={materials.mercury} onPointerOver={() => hover(true)} onPointerOut={() => hover(false)}/>
                </group>
              </group>
              <group name="venus_BezierCircle_7" rotation={[0, 0.028, 0]} scale={12.235}>
                <group name="venus_5" position={[0, 0, 1]} rotation={[0, 0, Math.PI / 2]} scale={0.102}>
                  <mesh name="Object_8" geometry={nodes.Object_8.geometry} material={materials.venus} onPointerOver={() => hover(true)} onPointerOut={() => hover(false)}/>
                </group>
              </group>
              <group name="erath_BezierCircle_11" scale={16.115}>
                <group name="erath_8" position={[0, 0, 1]} rotation={[0.819, 0, 0]} scale={0.062} ref={earthRef}>
                  <mesh name="Object_11" geometry={nodes.Object_11.geometry} material={materials.earth} onPointerOver={() => hover(true)} onPointerOut={() => hover(false)} />
                </group>
              </group>
              <group name="mars_BezierCircle_14" scale={20.451}>
                <group name="mars_12" position={[0, 0, 1]} rotation={[0, 0, Math.PI / 2]} scale={0.025}>
                  <mesh name="Object_14" geometry={nodes.Object_14.geometry} material={materials.mars} onPointerOver={() => hover(true)} onPointerOut={() => hover(false)} />
                </group>
              </group>
              <group name="jupiter_BezierCircle_17" scale={28.775}>
                <group name="jupiter_15" position={[0, 0, 1]} scale={0.095}>
                  <mesh name="Object_17" geometry={nodes.Object_17.geometry} material={materials.jupiter} onPointerOver={() => hover(true)} onPointerOut={() => hover(false)}/>
                </group>
              </group>
              <group name="saturn_BezierCircle_21" scale={36.61}>
                <group name="saturn_19" position={[0, 0, 1]} scale={0.059}>
                  <group name="saturn_ring_18" position={[0.01, -0.067, 0]} rotation={[0, 0, 0.351]} scale={1.739}>
                    <mesh name="Object_22" geometry={nodes.Object_22.geometry} material={materials.saturn_ring} onPointerOver={() => hover(true)} onPointerOut={() => hover(false)}/>
                  </group>
                  <mesh name="Object_20" geometry={nodes.Object_20.geometry} material={materials.saturn} onPointerOver={() => hover(true)} onPointerOut={() => hover(false)}/>
                </group>
              </group>
              <group name="uranus_BezierCircle_24" scale={44.26}>
                <group name="uranus_22" position={[0, 0, 1]} rotation={[0, 0, Math.PI / 2]} scale={0.02}>
                  <mesh name="Object_25" geometry={nodes.Object_25.geometry} material={materials.uranus} onPointerOver={() => hover(true)} onPointerOut={() => hover(false)}/>
                </group>
              </group>
              <group name="neptune_BezierCircle_27" scale={49.927}>
                <group name="neptune_25" position={[0, 0, 1]} rotation={[0, 0, Math.PI / 2]} scale={0.024}>
                  <mesh name="Object_28" geometry={nodes.Object_28.geometry} material={materials.neptune} onPointerOver={() => hover(true)} onPointerOut={() => hover(false)}/>
                </group>
              </group>
              <group name="pluto_BezierCircle_30" scale={54.22}>
                <group name="pluto_28" position={[0, 0, 1]} rotation={[0, 0, Math.PI / 2]} scale={0.004}>
                  <mesh name="Object_31" geometry={nodes.Object_31.geometry} material={materials.pluto} onPointerOver={() => hover(true)} onPointerOut={() => hover(false)}/>
                </group>
              </group>
              <group name="moon_BezierCircle_33" position={[0, 6.426, 14.778]} scale={-1.879}>
                <group name="moon_31" position={[0, 0, 1]} rotation={[-0.023, 0, Math.PI / 2]} scale={0.096}>
                  <mesh name="Object_34" geometry={nodes.Object_34.geometry} material={materials.moon} onPointerOver={() => hover(true)} onPointerOut={() => hover(false)}/>
                </group>
              </group>
              ...
              <group name="sun_53" scale={5.997}>
                <mesh name="Object_56" geometry={nodes.Object_56.geometry} material={materials.material} onPointerOver={() => hover(true)} onPointerOut={() => hover(false)}/>
              </group>
            </group>
          </group>
        </group>
