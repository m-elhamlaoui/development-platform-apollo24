...
export default function Model(props) {
  ...
  const [tooltip, setTooltip] = useState({ visible: false, name: '', position: { x: 0, y: 0 } });
  ...
  const handlePointerOver = (e, planet) => {
    ...
    setTooltip({ visible: true, name: planet, position: { x: e.clientX, y: e.clientY } });
    console.log(`Hovered over ${planet}`);
};

const handlePointerOut = (e) => {
    e.stopPropagation();
    setHoveredPlanet(null);
    setTooltip({ visible: false, name: '', position: { x: 0, y: 0 } });
};
  ...
  const handlePlanetClick = (e, planetName) => {
    ...
    const updateCamera = () => {
        ...
        const newCameraPosition = planetPosition.clone().add(new THREE.Vector3(0, 0, 10));
